                ...
                <div class="card myshadow">
                    <div class="card-body">
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-3 row">
                                <jet-label for="csession" class="col-md-2 col-form-label form-label" value="Current Session" />
                                <div class="col-md-10">
                                    <jet-input disabled class="form-control" id="csession" type="text" v-model="form.csession"  placeholder="Current Session" />
                                </div>
                            </div>
                            <!-- <div class="mb-3 row">
                                <jet-label for="department" class="col-md-2 col-form-label form-label" value="Department" />
                                <div class="col-md-10">    
                                    <select class="form-control" id="department" name="" v-model="form.department">
                                        <option :value="ddept.id" v-for="(ddept, id) in thedept" :key="id">{{ ddept.name }}</option>
                                    </select>
                                </div>
                            </div>                           -->
        ...
        data() {
            return {
                form: this.$inertia.form({
                    ...
                    college: 0,
                    department: 0,
                    csession: this.currentsession.name,
                    csession_id: this.currentsession.id,
                    colleges: [],
                    departments: [],
                    from: 'admin',
                })
