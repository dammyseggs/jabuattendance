                ...
                <div class="card">
                    <div class="card-body">
                        <form @submit.prevent="submit">
                            ...
                            <p class="card-title-desc">Department Registration</p>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tbody>
                                <tr v-for="(dept, index) in thedept" :key="index">
                                    <td>{{dept.name}}</td>
                                    <td>{{dept.college.name}}</td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="mr-4"><Link type="button" class="btn btn-sm btn-primary" :href="route('admin.department.show', dept.id)" >Edit</Link></div>
                                            <div>
                                                <form @submit.prevent ="deleteDepartment(dept.id)">
...
import { Head, Link } from '@inertiajs/inertia-vue3'
    export default {
        ...
        methods: {  
            async submit() {
                this.form.post(this.route('admin.storedepartment'), {
